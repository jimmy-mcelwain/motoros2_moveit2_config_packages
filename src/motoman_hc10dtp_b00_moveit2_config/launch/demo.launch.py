...
def generate_launch_description():
      ...
      robot_description_file_path = os.path.join(
        get_package_share_directory("motoman_hc10dtp_b00_moveit2_config"), "config", "motoman_hc10dtp_b00.urdf.xacro"
      )

      robot_description_semantic_file_path = os.path.join(
        get_package_share_directory("motoman_hc10dtp_b00_moveit2_config"), "config", "motoman_hc10dtp_b00.srdf"
      )

      trajectory_execution_file_path = os.path.join(
        get_package_share_directory("motoman_hc10dtp_b00_moveit2_config"), "config", "moveit_controllers.yaml"
      )

      rviz_config_file_path = os.path.join(
        get_package_share_directory("motoman_hc10dtp_b00_moveit2_config"), "config", "moveit.rviz"
      )
      ...
      moveit_config = (
            MoveItConfigsBuilder("motoman_hc10dtp_b00", 
